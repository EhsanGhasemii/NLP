...
class CustOpt:
    def __init__(self, params, datalen, lr, min_lr = None):
        ...
        self.optimizer = torch.optim.Adam(params, lr=lr, weight_decay=0.00001)  #, weight_decay=0.000001
        self._step = 0
...
#    msg += f"      Validation Set: {test_file}, {len(validation_set)} samples" + "\n"
    ...
    optimizer = CustOpt(model.parameters(), mini_epoch_length, lr = 0.0002, min_lr=0.0002)
